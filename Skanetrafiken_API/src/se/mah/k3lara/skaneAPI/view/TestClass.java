...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		/** Deklarerar en string som h�mtar v�rden fr�n constantsKlassen. */
		String searchURL = Constants.getURL("80000", "81216", 20); // Malm� C =
																	// 80000,
																	// Lund C,
																	// 81216
																	// Malm�
		...
		/**
		 * Str�ngen anv�nds i journey klassen och itererar genom en array som
		 * h�mtar data fr�n sk�netrafiken.
		 */
		...
		/**
		 * Deklarerar en string-array av klassen Station som sedan j�mf�r en
		 * str�ng med objecten som finns arrayn, vilket sedan printar ut
		 * stationer som liknar given str�ng med stationsnummer och namn.
		 */
