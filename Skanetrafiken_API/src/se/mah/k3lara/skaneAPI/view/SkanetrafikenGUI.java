...
public class SkanetrafikenGUI extends JFrame {
	...
	public SkanetrafikenGUI() {
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addComponent(panel, GroupLayout.PREFERRED_SIZE, 955, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 955, GroupLayout.PREFERRED_SIZE)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 1080, GroupLayout.PREFERRED_SIZE)
		...
		lblNewLabel_1.setIcon(new ImageIcon(SkanetrafikenGUI.class.getResource("/se/mah/k3lara/skaneAPI/view/Grafiko-profilo (2).png")));
		...
		textField.setBounds(500, 47, 309, 42);
		panel.add(textField);
		
		textField_1 = new JTextField();
		textField_1.setText("Linje");
		textField_1.setFont(new Font("Tahoma", Font.PLAIN, 40));
		textField_1.setColumns(10);
		textField_1.setBounds(819, 47, 124, 42);
		panel.add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setText("Mot");
